module github.com/StickFightDev/StickFightDedicatedSrv

go 1.14

require (
	github.com/JoshuaDoes/gofuckyourself v0.0.0-20201221071701-1ff372c26781
	...
	github.com/StickFightDev/steamcmd v0.0.0-20210824010843-35473e65c2b6
